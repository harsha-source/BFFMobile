...
@FeignClient(name = "customers-service", url = "http://internal-bookstore-dev-InternalALB-1706046400.us-east-1.elb.amazonaws.com/customers:3000", configuration = FeignConfig.class)
